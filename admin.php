    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 d-flex align-items-center justify-content-center position-relative my-5">
                    <div class="d-flex justify-content-center gap-4 mt-4">
                        <a href="admin_persone" class="btn btn-page btn-lg px-5 py-3">Gestione Persone</a>
